...
extern void *mono_aot_module_QuickTodoiOS_info;
...
extern void *mono_aot_module_QuickTodo_info;
...
{
	mono_aot_register_module (mono_aot_module_QuickTodoiOS_info);
	...
	mono_aot_register_module (mono_aot_module_QuickTodo_info);
...
void xamarin_setup ()
{
	...
	xamarin_executable_name = "QuickTodoiOS.exe";
